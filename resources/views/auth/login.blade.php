			...
			<div class="page-content d-flex align-items-center justify-content-center">
                ...
                <div class="col-md-8 ps-md-0">
                  <div class="auth-form-wrapper px-4 py-5">
                    <a href="#" class="noble-ui-logo logo-light d-block mb-2">CPA-<span>KIMANI</span></a>
                    ...
                    <form class="forms-sample" method="POST" action="{{ route('login') }}">
                      ...
                      <a href="register.html" class="d-block mt-3 text-muted" style="text-decoration: underline ">Fogot your Password?</a>
                    </form>
                  </div>
                </div>
              </div>
